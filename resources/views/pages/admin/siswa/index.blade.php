                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="{{ route('upload.create') }}" class="btn btn-success btn-sm mx-3"><i class="nav-icon fas fa-edit"></i> &nbsp; Lihat Rapor</a>
                                                <a href="{{ route('upload.create') }}" class="btn btn-success btn-sm mx-3"><i class="nav-icon fas fa-edit"></i> &nbsp; Upload Rapor</a>
